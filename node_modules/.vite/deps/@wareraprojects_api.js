...
// node_modules/@wareraprojects/api/dist/index.js
...
function createPostQueryFetch(origFetch) {
  ...
  return (input, init) => {
    ...
    const method = ((init == null ? void 0 : init.method) ?? (isRequest ? input.method : "GET")).toUpperCase();
    if (method !== "GET") {
      return f(input, init);
    }
...
function createBatchLoggingFetch(origFetch, logBatches) {
  ...
  return (input, init) => {
    ...
    try {
      ...
      if (isBatch) {
        const body = typeof (init == null ? void 0 : init.body) === "string" ? init.body : void 0;
        logFn({
          method: ((init == null ? void 0 : init.method) ?? input.method ?? "GET").toUpperCase(),
          url: urlObj.toString(),
          path: lastSegment,
          paths,
...
function createAPIClient(options) {
  const appliedRateLimit = (options == null ? void 0 : options.rateLimit) ?? ((options == null ? void 0 : options.apiKey) !== void 0 ? 200 : 100);
  const baseFetch = (options == null ? void 0 : options.fetch) ?? globalThis.fetch;
  const loggedFetch = createBatchLoggingFetch(baseFetch, options == null ? void 0 : options.logBatches);
  ...
  const client = createTRPCUntypedClient({
    links: [
      ...(options == null ? void 0 : options.logger) === true ? [loggerLink()] : [],
      httpBatchLink({
        url: (options == null ? void 0 : options.url) ?? "https://api2.warera.io/trpc",
        fetch: rateLimitedFetch,
        maxURLLength: 16e3,
        headers() {
          return {
            ...(options == null ? void 0 : options.headers) ?? {},
            ...(options == null ? void 0 : options.apiKey) ? { "x-api-key": options.apiKey } : {}
          };
        }
      })
    ]
  ...
  const makeProxy = (parts) => new Proxy(() => {
    ...
    apply(_t, _thisArg, argArray) {
      ...
      const input = (argArray == null ? void 0 : argArray[0]) ?? {};
...
*/
//# sourceMappingURL=@wareraprojects_api.js.map
